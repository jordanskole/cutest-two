      ...
      <div id="section-0">        
        <header>        
          <h2 class="section-title">
            <span>Jordan</span> <em>and</em> <span>Heather</span>
          </h2>
        </header>
        <p class="subline">Invite You to Celebrate At their Wedding</p>
        <img src="img/hero.jpg" alt="Placeholder" class="hero-unit fade-in" />
        <div class="row divider date-section">
          <div class="large-6 small-12 columns">
            <div class="date-container col-1">
              <span class="day-date">Saturday, August 16</span>
          ...
          <div class="large-6 small-12 columns">
            <div class="date-container col-2">
              ...
              <span class="day-location accent">Cherry Basket Farm</span>
        ...
        <div class="small-12 large-10 large-centered columns">                        
          <div class="row">
            <div class="small-12 large-6 columns section-groom">
              <img src="img/jordan_square.jpg" alt="Groom"/>
      ...
      <div id="section-2" class="row">          
        ...
        <div class="small-12 columns">
          <ul class="clearing-thumbs" data-clearing>
            <li>
              <a href="img/engagement_2.jpg">
                <img src="img/engagement_2.jpg" alt="The Engagement" class="fade-in">
                <span class="overlay-label">The Engagement</span>
              </a>
            </li>
            <li>
              <a href="img/the_dog.jpg">
                <img src="img/the_dog.jpg" alt="The Dog" class="fade-in">
                <span class="overlay-label">The Dog</span>
              </a>
            </li>
            <li>
              <a href="img/the_city.png">
                <img src="img/the_city.png" alt="The City" class="fade-in">
                <span class="overlay-label">The City</span>
              </a>
            </li>
            <li>
              <a href="img/the_legend.png">
                <img src="img/the_legend.png" alt="The Legend" class="fade-in">
